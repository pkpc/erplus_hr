<template>
  <a class="vux-datetime weui-cell weui-cell_access" href="javascript:">
    <slot>
      <div class="weui-cell__hd" :style="{flex: hdFlex}">
        <p :style="{width: $parent.labelWidth, textAlign: $parent.labelAlign, marginRight: $parent.labelMarginRight}" v-html="title"></p>
        <inline-desc v-if="inlineDesc">{{inlineDesc}}</inline-desc>
      </div>
      <div class="weui-cell__ft vux-cell-primary vux-datetime-value" :class="{'weui-cell__ft__ph':!currentValue&&placeholder}" :style="{textAlign: valueTextAlign, flex: valueFlex}">
        {{ _value }}
